...
enum custom_layers {
    _BL,
    _FL, //If you want a function layer.
    _NAV,
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT_65_ansi_blocker(
        LT(_FL, KC_ESC), KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS, KC_EQL,  KC_BSPC, KC_DEL,
...
// No need for process_record_user with this simple MO() setup
